...
/**
 * ****************************************************************************
 * @Package:      [cn.ccsgroup.ccsframework.exception.AnnotationHandlerMethodExceptionResolver.java]  
 * @ClassName:    [AnnotationHandlerMethodExceptionResolver]   
 * @Description:  [通用异常返回错误信息处理]   
 * @Author:       [weiwen ]   
 * @CreateDate:   [2013-12-2 下午4:06:36]   
 * @UpdateUser:   [weiwen(如多次修改保留历史记录，增加修改记录)]   
 * @UpdateDate:   [2013-12-2 下午4:06:36，(如多次修改保留历史记录，增加修改记录)]   
